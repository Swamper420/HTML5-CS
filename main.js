...
import { $, clamp, rand, randPick } from './js/utils.js';
import {
  WEAPONS, SPRAY_AK, SLOT_ORDER, PRIMARIES, NADE_DEFS, NADE_ORDER, isNadeKey,
  MAP_HALF, EYE, CROUCH_EYE_DROP, STAND_HEIGHT, CROUCH_HEIGHT, CROUCH_JUMP_LIFT, STEP_EPS,
  WALLRUN, PLAYER_BODY_CULL_Y, ROUND_TIME, BUY_TIME, FREEZE_TIME, ROUNDS_TO_WIN_MATCH,
  MONEY_START, MONEY_KILL, MONEY_WIN, MONEY_LOSS, MONEY_DRAW, MONEY_MAX,
  SITES, BOMB_PLANT_TIME, BOMB_DEFUSE_TIME, BOMB_TIMER,
} from './js/config.js';
...
/* ============================================================
   ...
   Modules: js/utils.js (helpers) + js/config.js (tunable data).
   Next splits: audio, map, bots, combat — see js/ headers.
   ============================================================ */
...
// Settings + audio live in js/ modules (see file headers for ownership).
import {
  opts, SET, loadSettings, saveSettings, applySettings,
  settingsOpen, closeSettings, wireSettingsUI,
  lookSens, swayK, shakeK, bindSettingsHooks,
} from './js/settings.js';
