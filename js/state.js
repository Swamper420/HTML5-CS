...
export const newLoadout = () => ({ ak: { owned: false, mag: 0, reserve: 0 }, deagle: { owned: true, mag: 7, reserve: 35 }, awp: { owned: false, mag: 0, reserve: 0 }, p90: { owned: false, mag: 0, reserve: 0 }, helix: { owned: false, mag: 0, reserve: 0 }, portal: { owned: false, mag: 0, reserve: 0 }, machete: { owned: true, mag: 0, reserve: 0 } });
...
export const player = {
  ...
  weapons: { ak: { owned: false, mag: 0, reserve: 0 }, deagle: { owned: true, mag: 7, reserve: 35 }, awp: { owned: false, mag: 5, reserve: 0 }, p90: { owned: false, mag: 0, reserve: 0 }, helix: { owned: false, mag: 0, reserve: 0 }, portal: { owned: false, mag: 0, reserve: 0 }, machete: { owned: true, mag: 0, reserve: 0 } },
